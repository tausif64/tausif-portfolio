          ...
          <div class="row w-100 p-3">
            <div class="col-lg-6 col-md-12 col-sm-12 px-lg-5 border border-start-0 border-top-0 border-bottom-0">
                <div class="card mt-3 bg-transparent">
                  <img src="/tausif-portfolio/assets/img/shiva.png" height="300px" alt="Project 1" />
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 px-5">
                <div class="card mt-3 bg-transparent">
                    <img src="/tausif-portfolio/assets/img/idea.png" height="300px" alt="Project 2" />
                      <div class="p-3 p-details">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 px-5">
                <div class="card mt-3 bg-transparent">
                    <img src="/tausif-portfolio/assets/img/project-3.png" height="300px" alt="Project 3" />
                      <div class="p-3 p-details">
